...
*I would like to be able to take query options from a csv table, that way users can plan their approach and import it without having to adjust a script*
```{r}
library("rentrez")
...
# query7 <- "(Lachnum[ORGN] OR Lachnellula[ORGN] AND (rRNA[Feature] OR misc_RNA[Feature])) 
#             NOT(Lachnellula willkommii[ORGN] OR environmental samples[organism] OR metagenomes[orgn] 
#             OR unidentified[orgn])"
# query8 <- "(Helotiales[ORGN] OR Sclerotinia[ORGN] OR Phialocephala[ORGN] OR Marssonina[ORGN] 
#             OR Lachnellula[ORGN] AND (rRNA[Feature] OR misc_RNA[Feature])) 
#             NOT(Lachnellula willkommii[ORGN] OR environmental samples[organism] OR metagenomes[orgn] 
#             OR unidentified[orgn])"
```
